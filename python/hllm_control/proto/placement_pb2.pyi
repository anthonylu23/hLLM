...
class DeploymentPlan(_message.Message):
    __slots__ = ("schema_version", "planner_version", "plan_id", "plan_digest", "manifest_digest", "workload_id", "planning_mode", "execution_dtype", "activation_dtype", "split_layer", "stages", "selected_candidate_id", "duplicated_tensor_groups", "deployment_version", "workload_digest", "profile_bundle_digest", "weight_dtype")
    ...
    WEIGHT_DTYPE_FIELD_NUMBER: _ClassVar[int]
