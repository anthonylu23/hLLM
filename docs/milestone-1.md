...
planning estimates. The [MLX worker](milestone-3.md) now executes both architectures
with F32/F16 and qualifies CPU/MLX locally. Python accepts one-stage plans for the unsplit reference; the
